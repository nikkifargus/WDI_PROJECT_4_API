...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post genres_url, params: { genre: { description: @genre.description, name: @genre.name } }, as: :json
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { description: @genre.description, name: @genre.name } }, as: :json
    assert_response 200
  end
